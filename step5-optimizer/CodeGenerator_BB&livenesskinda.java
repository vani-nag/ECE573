...
*/
		...
		public void liveness(InstructionList isl)
		{
			...
			while(i >= 0 )
			{
				...
				for(String s: this.liveOut.get(temp))
					liveSet.add(s);
				//System.out.println(String.valueOf(i)+"\t"+temp.toString()+"\t");
				//System.out.println(liveSet.toString()+"\t");
	...
	liveSet.remove(temp.getDest());if(temp.getsrc1().charAt(0) == '$') liveSet.add(temp.getsrc1());if(temp.getsrc2().charAt(0) == '$') liveSet.add(temp.getsrc2()); break;
						...
						case POPINT: if(temp.getsrc1().charAt(0) == '$') liveSet.add(temp.getsrc1()); break;
						case PUSHFLOAT: if(temp.getsrc1().charAt(0) == '$') liveSet.add(temp.getsrc1()); break;
						case POPFLOAT: if(temp.getsrc1().charAt(0) == '$') liveSet.add(temp.getsrc1()); break;
			...
			for (Instruction name: liveOut.keySet()){
		...
		public void registerAllocation()
		{
			...
			for(Instruction i: this.il)
			{
				...
				{//HERE get&put?
					...
					case ADD: rx = "r"+String.valueOf(ensure(i.getOperand(src1),0)); 
