		...
		public void registerAllocation(InstructionList isl, Map<Integer,LinkedList<String>> liveOut)
		{
			...
			for(Instruction i: k)
			{
				...
				{//HERE get&put?
					...
					//INT
					case ADD: rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 0, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Add(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case ADDI: if(i.getsrc1().charAt(0) == '$')
						rx = "r"+String.valueOf(ensure(i.getsrc1(),0));
						else rx =  i.getsrc1();
					if(i.getsrc2().charAt(0) == '$')
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					else ry = i.getsrc2();
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 0, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Addi(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case SUB: rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 0, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Sub(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;
 
					case MUL: rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 0, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Mul(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break; 

					case DIV:rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 0, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Div(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break; 
					

					//FLOAT
					case FADDS: rx = "r"+String.valueOf(ensure(i.getsrc1(),1)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),1)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new FAdd(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case FSUBS: rx = "r"+String.valueOf(ensure(i.getsrc1(),1)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),1)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new FSub(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;
 
					case FMULS: rx = "r"+String.valueOf(ensure(i.getsrc1(),1)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),1)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new FMul(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case FDIVS: rx = "r"+String.valueOf(ensure(i.getsrc1(),1)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),1)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new FDiv(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case FLT: rx = "r"+String.valueOf(ensure(i.getsrc1(),1)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),1)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Flt(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case FLE:rx = "r"+String.valueOf(ensure(i.getsrc1(),1)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),1)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Fle(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case FEQ: rx = "r"+String.valueOf(ensure(i.getsrc1(),1)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),1)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					if(live.get(i).contains(src2))
						free(this.intRegList.indexOf(getsrc2()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Feq(rx,ry,rz));
					this.dirtyIntRegList.put(rz,1);break;


					//1 operand
					case NEG:  rx = "r"+String.valueOf(ensure(i.getsrc1(),0));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Neg(rx,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case FNEGS: rx = "r"+String.valueOf(ensure(i.getsrc1(),1));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new FNeg(rx,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case MV: rx = "r"+String.valueOf(ensure(i.getsrc1(),0));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Mv(rx,rz));
					this.dirtyIntRegList.put(rz,1);break;

					case FMVS: rx = "r"+String.valueOf(ensure(i.getsrc1(),1));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new FMv(rx,rz));
					this.dirtyIntRegList.put(rz,1);break;


					//Get & Put
					case GETI: rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new GetI(rz));
					this.dirtyIntRegList.put(rz,1);break;

					case GETF: rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new GetF(rrz));
					this.dirtyIntRegList.put(rz,1);break;

					case PUTI:rx = "r"+String.valueOf(ensure(i.getsrc1(),0));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					this.code.add(new PutI(rx));break;

					case PUTF:rx = "r"+String.valueOf(ensure(i.getsrc1(),1));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					this.code.add(new PutF(rx));break;

					case PUTS: this.code.add(new PutF("x3"));break;


					//Branches
					case BLT: rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
					...
					case BLE: rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
					...
					case BGT: rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
					...
					case BGE:  rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
					...
					case BNE:  rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
					...
					case BEQ:  rx = "r"+String.valueOf(ensure(i.getsrc1(),0)); 
					ry = "r"+String.valueOf(ensure(i.getsrc2(),0)); 
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					if(live.get(i).contains(src2))
					...
					//Push/pop
					case PUSHINT: rx = "r"+String.valueOf(ensure(i.getsrc1(),0));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 0, i);
					this.code.add(new Sw(rx, "sp", "0"));break;

					case POPINT: rz = "r"+String.valueOf(allocate(i.getDest(), 0));
					this.code.add(new Lw(rz, "sp", "0"));
					this.dirtyIntRegList.put(rz,1);break;

					case PUSHFLOAT: rx = "r"+String.valueOf(ensure(i.getsrc1(),1));  
					if(this.liveOut.get(i).contains(src1))
						free(this.intRegList.indexOf(getsrc1()), 1, i);
					this.code.add(new Fsw(rx, "sp", "0"));break;

					case POPFLOAT: rz = "r"+String.valueOf(allocate(i.getDest(), 1));
					this.code.add(new Flw(rz, "sp", "0"));
					this.dirtyIntRegList.put(rz,1);break;
