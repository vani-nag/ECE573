...
import assembly.TypeCodeGenerator;
...
public class Compiler {
	...
	public static void main(String args[]) {
		...
		try {
			...
			TypeCodeGenerator tcg = new TypeCodeGenerator();
			CodeObject tco = tcg.run(ast);
			...
			// Print out the Type. Runme script will redirect as necessary
